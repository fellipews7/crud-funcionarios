        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocFederal = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuncionariosEnderecos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FuncionariosEnderecos_Cidades_CidadeId",
                        column: x => x.CidadeId,
                        principalTable: "Cidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuncionariosEnderecos_Funcionarios_FuncionarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuncionariosEnderecos_CidadeId",
                table: "FuncionariosEnderecos",
                column: "CidadeId");

            migrationBuilder.CreateIndex(
                name: "IX_FuncionariosEnderecos_FuncionarioId",
                table: "FuncionariosEnderecos",
